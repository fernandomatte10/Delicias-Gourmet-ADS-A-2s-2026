...
document.addEventListener("click", (event) => {
  ...
  // Botão "Finalizar compra" do produto: adiciona o item e abre
  // imediatamente o carrinho para o cliente concluir o pedido.
  const finishNow = event.target.closest(".finish-now");

  if (finishNow) {
    addToCart(finishNow.closest(".card"));
    openCart();
  }
...
// Botão "Finalizar compra": leva o cliente diretamente para o carrinho,
// onde ele confere os itens e pode finalizar o pedido.
$("finish-cart-button").addEventListener("click", openCart);
...
// O carrinho começa fechado e só abre quando o cliente clicar em
// "Carrinho" ou "Finalizar compra".
renderCart();
closeCart();
